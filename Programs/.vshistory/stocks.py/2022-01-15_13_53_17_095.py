...
class stock_information():
   # global stock_chose,ticker
    ...
    def stock_choice_get(self,stock_name_get):
        ...
        self.ticker=yf.Ticker(self.stock_chose)
    ...
    def comp_info_get(self):
        ...
        for x in range(len(stock_company_information)):
            messagebox.showinfo('Company Information',f'{stock_company_information[x].capitalize()}: {self.ticker.info[stock_company_information[x]]}')
