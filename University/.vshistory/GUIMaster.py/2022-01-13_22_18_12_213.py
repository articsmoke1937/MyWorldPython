 ...
 def __init__(self, parent, controller):
   ...
   #t=1
    for x in range(len(joke_menu)):
        ...
        b=Button(self, text=btn_text, command = lambda btn_text=x:[games_call.chuck_jokes.display_joke(controller,btn_text),controller.show_frame(chuck_norris_jokes)])
        b.pack()
        button.append(b)
