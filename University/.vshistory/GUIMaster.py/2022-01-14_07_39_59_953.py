...
class rocks_paper_scissors(Frame):  
  ...
  def __init__(self, parent, controller):
    ...
    label.grid(pady=10,padx=10, column=1)
    ...
    rock_btn.grid(pady=10,padx=10, column=4,row=2)
    paper_btn.grid(pady=10,padx=10, column=4,row=3)
    scissors_btn.grid(pady=10,padx=10, column=4,row=4)
    games_menu_btn.grid(pady=10,padx=10, column=4,row=2)
    main_menu_btn.grid(pady=10,padx=10, column=5, row=2)
